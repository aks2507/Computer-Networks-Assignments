...
//# mknod /dev/memory c 60 0//create a file before going further
int memory_init(void) 
{
  int result;
  result = register_chrdev(memory_major, "memory", &memory_fops);/* Registering device with the file created*/
  if (result < 0) 
  {

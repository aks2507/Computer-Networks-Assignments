...
char *path1 = "./fsock1"; // for at

char* path2 = "./fsock4"; // for R2
char* path3 = "./fscok5"; // for R3
...
int main() 
{
    ...
    cli_conn(name2,path2);
    cli_conn(name3,path3);
    while (1)
    {
